...
class Flow(nn.Module):
    ...
    @loc.setter
    def loc(self, value: torch.Tensor):
        self._loc = value
    ...
    def sample(self, sample_shape=torch.Size()):
        ...
        shape = sample_shape + cond.shape[:-1]
        u = self.base_dist.sample(shape)

        u = rearrange(u, "n b ... -> (n b) ...")
        cond = repeat(cond, "b ... -> (n b) ...", n=shape[0])
        sample, _ = self.inverse(u, cond)
        sample = rearrange(sample, "(n b) ... -> n b ...", n=shape[0])
